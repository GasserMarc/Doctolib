...
def test_list_functions():
    assert list_functions("../Exemples_codes/EventCandidatA.rb") == ['opening?', 'appointment?', 'self.availabilities',
    ...
    assert len(list_functions("../Exemples_codes/EventCandidatA.rb")) == 10
    assert list_functions("../Exemples_codes/EventCandidateB.rb") == ["self.availabilities", "self.event_specific_query",
...
def test_compte_commentaires():
    assert compte_commentaires("../Exemples_codes/EventCandidatA.rb") == 0
    # le nombre de # ne correspond pas au nombre de commentaires avec la convention adoptée
    assert compte_commentaires("../Exemples_codes/EventCandidateB.rb") != 21
    assert compte_commentaires("../Exemples_codes/EventCandidateB.rb") == 19
    assert compte_commentaires("../Exemples_codes/EventCandidateC.rb") == 8

def test_list_tests():
    assert list_tests("../Exemples_codes/EventCandidatATest.rb") != None
    assert len(list_tests("../Exemples_codes/EventCandidatATest.rb")) == 13

def test_count_boucles():
    assert count_boucles("../Exemples_codes/EventCandidatA.rb") == 3

def test_listes_de_variables():
    assert len(listes_de_variables("../Exemples_codes/EventCandidatA.rb")) == 6
