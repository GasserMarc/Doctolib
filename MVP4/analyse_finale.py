...
def dico_graphe(liste_candidats):
    dico_candidats={}
    taille_moyenne_fonction, tooLongLines, duplication_sur_texte, densite_de_commentaires, \
                              pourcentage_variables_mal_nommees = [], [], [], [], []
    caracteristiques = [taille_moyenne_fonction, tooLongLines, duplication_sur_texte, densite_de_commentaires, \
                              pourcentage_variables_mal_nommees]
    for candidat in liste_candidats:
        notes_candidats = note_code_candidat(candidat)
        for car in caracteristiques:
            car.append(notes_candidats[str(car)])
